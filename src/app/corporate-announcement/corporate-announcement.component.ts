...
import { SurveyAnnouncementService } from '../survey-announcement/survey-announcement.service';
declare var showToastMessage: any;
declare var $: any;
@Component({
  selector: 'app-corporate-announcement',
  templateUrl: './corporate-announcement.component.html',
  styleUrls: ['./corporate-announcement.component.css']
})
export class CorporateAnnouncementComponent implements OnInit {
  ...
  priveledge: any;
  menuLink = "corporateAnnouncement";
  constructor(
  ...
  ngOnInit(): void {
    ...
    this.commonServiceCall.pageName = "Corporate Announcement";
  ...
  navigatePage() {
    this.commonDataService.submenuname = "corporateAnnouncementAdd";
    this.router.navigateByUrl("/corporateAnnouncementAdd");
  }
  ...
  getAnnouncementDtls(item) {
    ...
    if (item.statusName === 'CORP_APPROVER_PENDING' && this.commonDataService.roleType == this.commonDataService.corpMakerRole) {
      ...
      this.commonDataService.submenuname = "corporateAnnouncementEdit";
      ...
      this.router.navigateByUrl("/corporateAnnouncementEdit", { state: { id: item.id } });
    }
  }
