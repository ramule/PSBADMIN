...
@Component({
  selector: 'app-survey-add-question-edit',
  templateUrl: './survey-add-question-edit.component.html',
  styleUrls: ['./survey-add-question-edit.component.css']
})
export class SurveyAddQuestionEditComponent implements OnInit {
  ...
  constructor(
    ...
    public serviceEditQue : SurveyAddQuestionEditService
  ) { }
  ...
  ngOnInit() {
    ...
    this.getStatus();
    var param = this.serviceEditQue.getSurveyDtls(this.surveyId);
  ...
  updateSurveyQuesAns() {
    ...
    if (this.surveyAddQuestionForm.valid) {
      ...
      var param = this.serviceEditQue.getUpdateParam(this.surveyId.surveyId,formData,userDetails.user_ID,this.questionDtl);
      console.log(param);
