...
export class ImpsDeliveryChannelEditService {
...
    public commonMethod: CommonMethods
  ...
  editDeliveryChannelCall(formData, beforeParams, isMPINNeeded, isAccNumPartial, isCustomerAuthenticated, isRemMobileNeeded) {
...
     "ChannelName": "DESKTOP",
     "channelRequest": URL,
     "eventName":'IMPS Delivery Channel Edit',
     "category":"IMPS",
     "action":operation,
     "properties":URL,
