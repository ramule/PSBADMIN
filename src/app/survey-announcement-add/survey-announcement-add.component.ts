...
@Component({
  ...
  templateUrl: "./survey-announcement-add.component.html",
  styleUrls: ["./survey-announcement-add.component.css"],
})
export class SurveyAnnouncementAddComponent implements OnInit {
  ...
  constructor(
    ...
    private annoucmentService: SurveyAnnouncementAddService,
  ...
  openActionModel(action, formdata) {
    ...
    if (this.announcementAddForm.valid) {
      ...
      this.announcementAddFields.announcementHeaderName = formdata.announcementHeaderName;
      ...
      this.formErrors = this.formValidation.validateForm(this.announcementAddForm, this.formErrors, false)
    }
  }
  ...
  addAnnouncementWithRemark(formdata){
    ...
    if (this.remarkForm.valid) {
      closeTinyModel();
      var param = this.annoucmentService.getAnnouncementParamsWithRemark(this.announcementAddFields, this.images, this.userDtls, this.remarkForm.value);
  ...
  addAnnouncement() {
    ...
    if (this.announcementAddForm.valid) {
      ...
      var param = this.annoucmentService.getAnnouncementParams(
  ...
  filterProducts() {
    return this.productType.filter(
      (x) => x.shortName == "MOBILE" || x.shortName == "DESKTOP"
    );
  }
