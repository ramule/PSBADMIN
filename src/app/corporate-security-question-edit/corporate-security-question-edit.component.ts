...
@Component({
  selector: "app-corporate-security-question-edit",
  templateUrl: "./corporate-security-question-edit.component.html",
  styleUrls: ["./corporate-security-question-edit.component.css"],
})
export class CorporateSecurityQuestionEditComponent implements OnInit {
  beforeParam: any = [];
  ...
  constructor(
    ...
    private masterSecurityQuestionEditService: CorporateSecurityQuestionEditService
  ) { }
  ...
  ngOnInit() {
    ...
    if(this.commonData.browserRefresh) {
      this.buildForm();
      this.router.navigateByUrl('/corporateSecurityQuestion');
      return;
    }

    this.masterSecQuestion = this.location.getState();
    this.commonServiceCall.pageName = "Edit Corporate Security Question";
  ...
  cancel() {
    if (
      this.commonServiceCall.makerRequestEditUrl == "/corporateSecurityQuestion"
    ) {
      this.router.navigateByUrl("/corporateSecurityQuestion");
