...
//corpAuditActivityLog

@Component({
  selector: 'app-corporate-audit-activity-log',
  templateUrl: './corporate-audit-activity-log.component.html',
  styleUrls: ['./corporate-audit-activity-log.component.css']
})
export class CorporateAuditActivityLogComponent implements OnInit {
  id = 7;
  menuLink = "corpAuditActivityLog";
  ...
  ngOnInit(): void {
    ...
    this.commonServiceCall.pageName = "Corporate Activity Log";
    this.getLeftMenuId();
  }
  ...
  addAuditTrailAdaptor(URL, operation) {
    var param = {
      "ChannelName": "DESKTOP",
      "channelRequest": URL,
      "eventName": 'Corporate Activity Log',
      "category": "Corporate",
      "action": operation,
      "properties": URL,
