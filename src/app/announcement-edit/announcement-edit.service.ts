...
export class AnnouncementEditService {
  ...
  constructor(
    ...
    updateAnnouncementCall(formData, images, userDtls, id, announcementDta) {
      ...
      var inputData = {
        ...
        "createdby": announcementDta.createdby,
  ...
  updateAnnouncementWithRemarkCall(formData, images, userDtls, id, announcementDta, remarkData) {
    this.createdon = this.commonDataShareService.announcementData.createdon;
    var inputData = {
      "id": id,
      "announcementHeader": formData.announcementHeaderName,
