...
declare var $: any;
@Component({
  selector: 'app-corporate-offers-add',
  templateUrl: './corporate-offers-add.component.html',
  styleUrls: ['./corporate-offers-add.component.css']
})
export class CorporateOffersAddComponent implements OnInit {
  ...
  constructor(
    ...
    private corpOfferService: CorporateOffersAddService,
  ...
  addAuditTrailAdaptor(URL, operation) {
    var param = this.corpOfferService.addAuditTrailAdaptorParams(URL, operation);
    console.log(param)
  ...
  addCustOfferMasterWithRemark(formdata) {
    ...
    if (this.remarkForm.valid) {
      ...
      var param = this.corpOfferService.getOfferAddParamWithRemark(this.customerOfferAddFields, this.images,this.userDtls, this.remarkForm.value);
  ...
  addCustOfferMaster() {
    ...
    if (this.customerOfferForm.valid) {
      ...
      var param = this.corpOfferService.getOfferAddParam(this.customerOfferForm.value, this.images,this.userDtls);
      this.uploadOffer(param);
    } else {
      this.formErrors = this.formValidation.validateForm(this.customerOfferForm, this.formErrors, false)
    }
