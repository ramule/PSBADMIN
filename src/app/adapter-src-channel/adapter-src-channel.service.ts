...
export class AdapterSrcChannelService {
  user_ID:any="";
  createdOn: any;
  constructor(
  ...
  addAdapterSourceChannelCall(formData) {
  ...
  addAdapterSourceChannelWithRemarkCall(formData, remarkData) {
    this.user_ID = this.commonDataService.user_ID;
    var inputData = {
  ...
  deleteChannelCall(formData) {
    ...
    var inputData = {
      ...
      "user_ID": this.user_ID,
      "subMenu_ID": this.commonDataService.submenuId,
      "activityName": 'ADAPTERSRCCHANNELDELETE',
      "remark": ''
    }
    return inputData;
  }
